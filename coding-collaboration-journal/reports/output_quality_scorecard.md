...
| Long-term memory method | Locally evidenced contract | Pattern promotion, counter-evidence, epochs, experiments, plus tested bounded and sanitized `SessionStart` injection for Codex/Claude. | Longitudinal usefulness needs several weeks of real operation. |
